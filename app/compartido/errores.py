...
class Codigo(StrEnum):
    ...
    SIN_PRECIO_DE_INSCRIPCION = "SIN_PRECIO_DE_INSCRIPCION"
    CODIGO_INCORRECTO = "CODIGO_INCORRECTO"
    CODIGO_VENCIDO = "CODIGO_VENCIDO"
    DEMASIADOS_REGISTROS = "DEMASIADOS_REGISTROS"
    ...
    CONTRASENA_INICIAL_SIN_CAMBIAR = "CONTRASENA_INICIAL_SIN_CAMBIAR"
    DEMASIADOS_INTENTOS = "DEMASIADOS_INTENTOS"
    CLAVE_INICIAL_VENCIDA = "CLAVE_INICIAL_VENCIDA"
